...
- **User can input temperature degrees both in Celsius or Fahrenheit degrees**
- **User can convert the input temperature to the other unit**
- **User can reset the input fields**
...
- [Live Demo Link](https://sergio-usma.github.io/temperature_converter_js/)
...
- [ ] **Automatic conversion without pressing the button**
- [ ] **Add a temperature scale to the input/output fields**
